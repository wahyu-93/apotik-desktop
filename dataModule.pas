...
type
  Tdm = class(TDataModule)
    ...
    qryBantu: TADOQuery;
    qryListPembelianPending: TADOQuery;
    dsListPembelianPending: TDataSource;
    qryListPembelianPendingid: TIntegerField;
    qryListPembelianPendingkode: TStringField;
    qryListPembelianPendingnama_supplier: TStringField;
    qryListPembelianPendingalamat_supplier: TMemoField;
    qryListPembelianPendingtelp_suplier: TStringField;
    qryListPembelianPendingid_1: TIntegerField;
    qryListPembelianPendingno_faktur: TStringField;
    qryListPembelianPendingtgl_pembelian: TDateField;
    qryListPembelianPendingsupplier_id: TIntegerField;
    qryListPembelianPendingjumlah_item: TIntegerField;
    qryListPembelianPendingtotal: TFloatField;
    qryListPembelianPendinguser_id: TIntegerField;
    qryListPembelianPendingstatus: TStringField;
    qryListPembelianPendingtgl_pembayaran: TDateField;
    qryListPembelianPendingno_faktur_supplier: TStringField;
    qryListPembelianPendingtgl_jatuh_tempo: TDateField;
    qryListPembelianPendingid_2: TIntegerField;
    qryListPembelianPendingnama: TStringField;
    ...
    qryRelasiSetHargaharga_beli_terakhir: TFloatField;
    ...
    qryRelasiSetHargaprodusen: TStringField;
    qryRelasiSetHargalokasi_simpan: TStringField;
    qryDetailBatch: TADOQuery;
    dsDetailBatch: TDataSource;
    qryDetailBatchobat_id: TIntegerField;
    qryDetailBatchkode: TStringField;
    qryDetailBatchnama_obat: TStringField;
    qryDetailBatchbatch_id: TIntegerField;
    qryDetailBatchno_batch: TStringField;
    qryDetailBatchtgl_expired: TDateField;
    qryDetailBatchqty_batch: TIntegerField;
    qryDetailBatchharga_beli: TFloatField;
    qryDetailBatchharga_jual: TIntegerField;
    qryDetailBatchtotal_jual: TLargeintField;
    qryDetailBatchlaba_batch: TFloatField;
    qryDetailBatchjenis_harga: TStringField;
    qryDetailBatchtgl_penjualan: TDateTimeField;
    qryLogKoreksi: TADOQuery;
    dsBatchKoreksi: TDataSource;
    qryBatchKoreksi: TADOQuery;
    qryBatchKoreksiid: TAutoIncField;
    qryBatchKoreksino_batch: TStringField;
    qryBatchKoreksitgl_expired: TDateField;
    qryBatchKoreksistok_sistem: TIntegerField;
    qryBatchKoreksistok_fisik: TIntegerField;
    qryBatchKoreksiselisih: TLargeintField;
    qryBatchSnap: TADOQuery;
    qryLaporanStokid: TIntegerField;
    qryLaporanStoknama_obat: TStringField;
    qryLaporanStokno_batch: TStringField;
    qryLaporanStoktgl_expired: TDateField;

...
type
  Tdm = class(TDataModule)
    ...
    qryLabaPenjualanid: TAutoIncField;
    qryLabaPenjualanobat_id: TIntegerField;
    qryLabaPenjualanharga_jual: TFloatField;
    qryLabaPenjualanharga_beli_terakhir: TIntegerField;
    qryLabaPenjualansupplier: TStringField;
    qryLabaPenjualansatuan: TStringField;
    qryLabaPenjualanjenis: TStringField;
    qryLabaPenjualancreated_at: TDateTimeField;
    qryLabaPenjualanid_1: TAutoIncField;
    qryLabaPenjualankode: TStringField;
    qryLabaPenjualanbarcode: TStringField;
    qryLabaPenjualannama_obat: TStringField;
    qryLabaPenjualankode_jenis: TIntegerField;
    qryLabaPenjualankode_satuan: TIntegerField;
    qryLabaPenjualantgl_obat: TDateField;
    qryLabaPenjualantgl_exp: TDateField;
    qryLabaPenjualanstatus: TStringField;
    qryLabaPenjualanstok: TIntegerField;
    qryLabaPenjualanlaba: TFloatField;
